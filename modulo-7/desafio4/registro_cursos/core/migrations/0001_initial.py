    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('modificacion_registro', models.DateField(auto_now=True)),
                ('creado_por', models.CharField(max_length=50)),
                ('cursos', models.ManyToManyField(related_name='estudiantes', to='core.curso')),
            ],
        ),
        migrations.CreateModel(
            name='Direccion',
        ...
        migrations.AddField(
            model_name='curso',
            name='profesor',
            field=models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to='core.profesor'),
        ),
    ]
